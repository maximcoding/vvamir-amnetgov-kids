...
angular.module('ng-laravel').controller('AssetsResourceCreateCtrl', function ($scope,$rootScope, AssetsResourceService, AssetsCategoryService, OrganizationService, $translatePartialLoader, Notification, trans) {
