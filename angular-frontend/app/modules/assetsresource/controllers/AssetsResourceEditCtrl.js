...
angular.module('ng-laravel').controller('AssetsResourceEditCtrl',function($scope,$rootScope,AssetsResourceService,OrganizationService,AssetsCategoryService,$stateParams,Notification,$translatePartialLoader,trans){
