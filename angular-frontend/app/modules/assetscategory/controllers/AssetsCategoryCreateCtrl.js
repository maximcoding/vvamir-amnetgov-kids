...
angular.module('ng-laravel').controller('AssetsCategoryCreateCtrl', function ($scope, AssetsCategoryService,$rootScope, $translatePartialLoader, Notification, trans) {
