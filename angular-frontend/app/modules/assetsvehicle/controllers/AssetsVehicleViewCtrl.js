...
app.controller('AssetsVehicleViewCtrl', function ($scope, AssetsVehicleService, $rootScope, OrganizationService, AssetsResourceService, AssetsResourceRelationService, AssetsCategoryService, $stateParams, $translatePartialLoader, trans) {
