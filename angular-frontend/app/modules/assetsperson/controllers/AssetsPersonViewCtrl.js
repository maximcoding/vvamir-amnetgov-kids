...
angular.module('ng-laravel').controller('AssetsPersonViewCtrl', function ($scope,$rootScope, NgMap, AssetsPersonService, PointService, OrganizationService, AssetsResourceRelationService, AssetsResourceService, AssetsCategoryService, $stateParams, $translatePartialLoader, trans) {
