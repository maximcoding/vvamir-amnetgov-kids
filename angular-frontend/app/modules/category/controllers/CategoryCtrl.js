...
angular.module('ng-laravel').controller('CategoryCtrl',function($scope,CategoryService,SweetAlert,Restangular,$rootScope,resolvedItems,$translatePartialLoader,Notification,trans){
