...
var app = angular.module('ng-laravel',['angular-flot']);
app.controller('flotchartCtrl',function($scope,$timeout){
    /* Flot Basic */
    var d1 = [];
    ...
    $scope.interactivityData =  [
        { data: sin, label: "sin(x)"},
        { data: cos, label: "cos(x)"}
    ];
    $scope.interactivityChartOptions ={
        series: {
            lines: {
                show: true
            },
    ...
    $scope.stackgData = [d1,d2,d3];



    /* Flot Real time chart*/
    var data = [], totalPoints = 200;
    // Chart set random data
    ...
    // set data in interval update time
    function setData(){
