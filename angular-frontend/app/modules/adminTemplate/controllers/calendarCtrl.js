...
angular.module('ng-laravel').controller('calendarCtrl',function($scope){

});

// fullCalendar custom directive
angular.module('ng-laravel').directive('fullCalendar',function(){
    return{
        restrict:'A',
...
angular.module('ng-laravel').directive('externalEvents',function(){
    return{
        restrict:'A',
        link: function(scope,element,attrs){
