...
angular.module('ng-laravel').controller('AssetsGroupDetailsCreateCtrl',function($scope,AssetsGroupDetailsService,AssetsDetailsGroupService,$translatePartialLoader,Notification,trans){
