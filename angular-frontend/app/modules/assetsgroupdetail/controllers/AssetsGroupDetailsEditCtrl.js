...
angular.module('ng-laravel').controller('AssetsGroupDetailsEditCtrl',function($scope,AssetsGroupDetailsService,$stateParams,Notification,$translatePartialLoader,trans){
