...
var app = angular.module('ng-laravel', ['dropzone', 'momentjs']); //'MQTTService',
app.controller('profileCtrl', function ($scope, $auth, $timeout, MessageService, UserService, OrganizationService, RoleService, $stateParams, $http, $translatePartialLoader, Notification, trans) {
    ...
    OrganizationService.show($scope.user.organization_id).then(function (data) {
        if (data.length == 1) {
            ...
            // assign public organization room
        }
