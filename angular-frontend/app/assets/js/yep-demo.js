        ...
        <div class='demo'>\
            ...
            <form data-persist='garlic' method='POST' >\
                ...
                <div class='images boxed-patterns'>\
                    <a id='bg_p1' href='#'><img alt='' src='app/assets/img/bg/bg_p1.jpg' height='25' width='25'></a>\
                    <a id='bg_p2' href='#'><img alt='' src='app/assets/img/bg/bg_p2.jpg' height='25' width='25'></a>\
                    <a id='bg_p3' href='#'><img alt='' src='app/assets/img/bg/bg_p3.jpg' height='25' width='25'></a>\
                    <a id='bg_p4' href='#'><img alt='' src='app/assets/img/bg/bg_p4.jpg' height='25' width='25'></a>\
                    <a id='bg_p5' href='#'><img alt='' src='app/assets/img/bg/bg_p5.jpg' height='25' width='25'></a>\
                    <a id='bg_p6' href='#'><img alt='' src='app/assets/img/bg/bg_p6.jpg' height='25' width='25'></a>\
                    <a id='bg_p7' href='#'><img alt='' src='app/assets/img/bg/bg_p7.jpg' height='25' width='25'></a>\
                </div>   \
                <legend class='no-padding'>Skins</legend>\
                <div class='images boxed-skins'>\
                    <a id='bg_style_1' href='#'><img alt='' src='app/assets/img/skin/skin-1.png' height='24' width='25'></a>\
                    <a id='bg_style_2' href='#'><img alt='' src='app/assets/img/skin/skin-2.png' height='24' width='25'></a>\
                    <a id='bg_style_3' href='#'><img alt='' src='app/assets/img/skin/skin-3.png' height='24' width='25'></a>\
                </div>\
            </form>\
        </div>";
$(function () {
    ...
    var checkboxes = $("#check-boxed").change(function () {
        if (this.checked) {
    ...
    $("#check-rtl").change(function () {
        if (this.checked) {
            $("head link[href='assets/vendors/bootstrap/css/bootstrap.min.css'] ").last().after("<link rel='stylesheet' href='app/assets/css/yep-rtl.css' type='text/css' media='screen'>");
            $('body').addClass('rtl');
        } else {
            $("head link[href='app/assets/css/yep-rtl.css'] ").remove();
