    ...
    class EntrustSetupTables extends Migration
    {
        ...
        public function up()
        {
            ...
            DB::table('users')->insert([
                ...
                array('organization_id' => '2', 'avatar_url' => 'no_avatar.jpg', 'email' => 'manager@gmail.com', 'firstname' => 'Manager AmnetIot', 'lastname' => 'Manager AmnetIot', 'password' => bcrypt(123123), 'created_at' => date("Y-m-d H:i:s")),
                array('organization_id' => '2', 'avatar_url' => 'no_avatar.jpg', 'email' => 'user@gmail.com', 'firstname' => 'User AmnetIot', 'lastname' => 'User AmnetIot', 'password' => bcrypt(123132), 'created_at' => date("Y-m-d H:i:s")),
            ]);
            /*
